...
// // This quick-change dropdown only offers Todo / In Progress — moving to
// // In Review requires the time-taken modal and moving to Done requires
// // manager review, neither of which this lightweight dropdown handles.
// // Those transitions still happen on the task detail page.
// const QUICK_STAGES = ["Todo", "In Progress"];
